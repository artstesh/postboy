...
Version 3.5 introduces a new middleware pipeline model that replaces the previous single-step middleware handling with a stage-based lifecycle. This change makes middleware more expressive, enables cancellation at specific stages, and provides better control over post-processing and error handling.
